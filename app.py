...
app.secret_key = 'zed'  # could do app.config['JWT_SECRET_KEY'] if we prefer
api = Api(app)
...
api.add_resource(UserAppoinments, '/user-appointments')
api.add_resource(UserAppoinments2, '/user-appointments2/<int:user_id>')
